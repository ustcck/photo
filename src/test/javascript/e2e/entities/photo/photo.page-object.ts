...
export default class PhotoComponentsPage extends AlertPage {
...
export class PhotoDeleteDialog {
  ...
  title: ElementFinder = element(by.id('photoApp.photo.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-photo'));
}
